...
function setup(){
 ...
 var floor=new THREE.Mesh(new THREE.BoxGeometry(34,30,0.1), new THREE.MeshLambertMaterial({map:texturap}));//Creo el material de la pared tipo Lambert con la textura dada
