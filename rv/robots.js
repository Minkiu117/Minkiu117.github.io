function setup() {
  ...
  var esferaFormas = new THREE.SphereGeometry(3, 100, 100, 0, Math.PI*2, 1*Math.PI/2, Math.PI/2);
  var esferaFormai = new THREE.SphereGeometry(3, 100, 100, 0, Math.PI*2, 3*Math.PI/2, Math.PI/2);
