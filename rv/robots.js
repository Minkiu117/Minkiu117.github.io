function setup() {
  ...
  var esferaForma = new THREE.SphereGeometry(1.3,100,50,0, Math.PI*2, 1*Math.PI/2, Math.PI);
  var mediaesferaForma = new THREE.SphereGeometry( 1.3, 100, 50, 0, Math.PI*2, 3*Math.PI/2, Math.PI);
