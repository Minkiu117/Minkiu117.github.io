function setup() {
  ...
  var esferaFormai = new THREE.SphereGeometry(9, 200, 200, 0, Math.PI*2, Math.PI, .5);
  var esferaFormas = new THREE.SphereGeometry(8, 200, 200, 0, Math.PI*2, 0, .65);
